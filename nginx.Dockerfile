...
# PHP extensions (same as Apache image)
...
# PHP runtime config (increase upload/post limits)
COPY docker/php/*.ini /usr/local/etc/php/conf.d/

# Nginx config: use project nginx.conf template
# and adapt it for container (root=/var/www/html, listen 8000, php-fpm at 127.0.0.1:9000)
...
# Generic entrypoint that prepares .env and runtime dirs
